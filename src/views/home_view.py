...
class HomeView(View):
    def __init__(self, window):
        ...
        generate_seed_view_button = Gtk.Button(
            ...
            name="home-view__navigation-button--selected"
        )
    ...
    def move_right(self):
        self.get_children()[self.index].set_name("home-view__navigation-button")

        self.index = (self.index + 1) % 2

        self.get_children()[self.index].set_name("home-view__navigation-button--selected")
